            ...
            <div class="row clearfix">
                ...
                <div class="col-md-6 column">
                    ...
                    <form onsubmit="onSubmit(); return false;">
                        ...
                        <textarea class="textarea thumbnail" id="textarea">
                        </textarea>
                        <div class="say-btn">
                    ...
                    <div>
                        ...
                        （当前在&nbsp;房间
                        <!--?php echo isset($_GET['room_id']) && intval($_GET['room_id']) -->
                    ...
                    <p class="cp">
                        PHP多进程+Websocket(HTML5/Flash)+PHP Socket实时推送技术&nbsp;&nbsp;&nbsp;&nbsp;Powered
                        by
                        <a href="http://www.workerman.net/workerman-chat" target="_blank">
                            workerman-chat
                        </a>
                    </p>
                </div>
                <div class="col-md-3 column">
                    ...
                    <a href="http://workerman.net:8383" target="_blank">
                        <img style="width:252px;margin-left:5px;" src="/img/workerman-todpole.png"
                        />
                    </a>
                </div>
            </div>
